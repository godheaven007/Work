...
layui.use(['element', 'form', 'Dialog', 'eleTree', 'DPTree', 'CWTree', 'Req' ,'Common', 'MouseWheel', 'Scroll'], function() {
    ...
    function getAuthSelectHtmlHandle(radioType, hasOtherDept) {
                                ...
                                '<div class="layui-tab layui-tab-brief" lay-filter="tabBrief">' +
                                    '<ul class="layui-tab-title">' +
                                        ...
                                        if(radioType == '1' && !hasOtherDept) {
                                            // 按园区&&范围不含【其他部门】
                                            if(typeof simplify != 'undefined' && simplify == '1') {
                                                // 精简版
                                            } else {
                                                _html += '<li>按角色设置</li>';
                                            }
        ...
        if(radioType == '1' && !hasOtherDept) {
            ...
            if(typeof simplify != 'undefined' && simplify == '1') {
                // 精简版
                _html += '<div style="position: absolute; bottom: -38px;"><a href="/simplify_settingorg/authpage" target="_blank" style="color:#1E9FFF;">权限解释</a></div>';
            } else {
