    ...
    if (typeof window.define === 'function') {
        if (window.define.amd) {
            ...
            layui.define('jquery', function (exports) {
                // exports('Editor', factory(layui.jquery));
                exports('Editor', factory(layui.jquery, global, global.document, global.Math));
            });
        } else {
            // 全局模式
    ...
    Txt.fn.bindPasteFilter = function () {
        ...
        $txt.on('paste', function (e) {
            ...
            if (editor.config.pasteText) {
                ...
                // 拼接为 <p> 标签
                if (pasteHtml) {
                    resultHtml = '<p>' + replaceHtmlSymbol(pasteHtml) + '</p>';
                }
...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        img: {
            normal: '<a href="#" tabindex="-1" class="wangeditor-upload"><i class="wangeditor-menu-img-picture"></i></a>',
            selected: '.selected'
        },
        video: {
